...
import net.pandariin.smrt.block.custom.PinkGarnetLampBlock;
...
public class ModBlocks {
    ...
    public static final Block PINK_GARNET_STAIR = registerBlock("pink_garnet_stair",
    ...
    public static final Block PINK_GARNET_LAMP = registerBlock("pink_garnet_lamp", new PinkGarnetLampBlock(AbstractBlock.Settings.create()
            .strength(1f).requiresTool().luminance(state -> state.get(PinkGarnetLampBlock.ON_STATE) ? 15 : 0)));
